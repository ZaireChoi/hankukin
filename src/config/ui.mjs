...
export const UI = {
  ...
  ja: {
    ...
    arrival: {
      ...
      s2a: '外国のカードは、店や飲食店ではほぼ問題なく使えます。違うのは韓国の**オンライン決済**です — 多くが3Dセキュアを求め、未登録のカードは説明もなく拒否されます。',
  ...
  'zh-hans': {
    ...
    arrival: {
      ...
      s1cta: '准备 eSIM',
      s2: '在需要之前先让卡能用',
      s2a: '你的外国卡在多数商店和餐厅都能刷。不一样的是韩国的**线上结账** —— 很多会走 3D Secure，未登记的卡会被直接拒绝，而且不会给你有用的说明。',
