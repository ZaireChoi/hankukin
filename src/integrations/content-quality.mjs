...
const HERO_EXEMPT = {
  ...
  'jjimjilbang-what-it-costs-and-what-it-is':
    '재고 54곳·292장에 **목욕·찜질·사우나·온천이 슬러그 하나도 없다** (파일명 검색 0건). ' +
    '한국관광공사 TourAPI 가 등재하는 것은 공공이 관리하는 관광지이고, 찜질방은 민간 업소라 거기 없다. ' +
    'photo-requests.json 에 다섯 건(스파랜드·아쿠아필드·한증막·수안보온천·아산온천)을 걸어 뒀다. ' +
    '그래서 이 기사는 도표로 나간다 — 가을편과 같은 판단이다. ' +
    '※ **다만 이 사유는 곧 만료된다.** 2026-08-22 위키미디어 공용에서 ' +
    '**CC0 찜질방·불가마·목욕탕 사진 21장(4032×3024)** 을 찾았다. 우리 스키마의 license 열거값에 들어간다. ' +
    '가져오는 경로만 정하면 되고, 가져온 뒤에는 **한 장씩 열어 보고** 이 줄을 지운다 ' +
    '(2026-08-20 이태원 건 — 「다섯 장 다 봤다」고 적어 놓고 넷째 장을 안 봤다).',
