...
const HERO_EXEMPT = {
  ...
  'olive-young-myeongdong-which-store':
    ...
    '들어올 길이 없다. 관광공사 TourAPI 는 민간 점포를 등재하지 않아 명동 상점 내부가 한 장도 없고 ' +
    '(찜질방 편에서 같은 벽을 만났다), 위키미디어 공용의 화장품 사진은 상표·포장이 그대로 찍혀 있어 ' +
    'CC0 라도 이 용도로는 못 쓴다. 명동 거리 사진을 대신 붙이는 것도 안 한다 — ' +
    '「그냥 서울 거리」가 되어 여덟 곳 중 어디를 가라는 이 기사의 요점과 아무 상관이 없어진다. ' +
    '그리고 요점 자체가 **역에서 몇 미터인가와 세금이 어디서 돌아오는가**라서 사진으로는 애초에 안 보인다 — ' +
